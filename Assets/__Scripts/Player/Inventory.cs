...
public class Inventory : MonoBehaviour
{
    ...
    void Start() {
        ...
        string sceneName = currentScene.name; // reads current scene name

        if (sceneName == "Parkour"){ // checks if current scene is names Parkour
            firstWeapon = plasmaSMG; // sets weapons
            secondWeapon = empAR;
        }else{
            if(slot1Wep == "empSMG"){firstWeapon = empSMG;} // checks static string ands sets weapons accordingly in slot 1
            ...
            if(slot2Wep == "empSMG"){secondWeapon = empSMG;} // checks static string ands sets weapons accordingly in slot 2
